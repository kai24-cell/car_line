...
def main():
    ...
    in_graph = os.path.join(directory, "deeplabv3_mnv2_cityscapes_train/frozen_inference_graph.pb")
    out_graph = os.path.join(directory, "optimized_graph_cityscapes.pb")
    inputs = ["sub_7"]
